...
import MessageFilledSVG from '@/svgs/message-filled.svg'
import MessageOutlineSVG from '@/svgs/message-outline.svg'
...
const list = [
	...
	{
		icon: MessageOutlineSVG,
		iconActive: MessageFilledSVG,
		label: '留言板',
		href: '/guestbook'
	}
]
