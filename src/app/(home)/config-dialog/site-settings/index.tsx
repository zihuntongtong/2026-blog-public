		...
		<div className='space-y-6'>
			...
			<div className='flex gap-3'>
				...
				<label className='flex items-center gap-2'>
					<input
						type='checkbox'
						checked={formData.enableSnow ?? false}
						onChange={e => setFormData({ ...formData, enableSnow: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
					<span className='text-sm font-medium'>开启下雪动画</span>
				</label>
				<label className='flex items-center gap-2'>
					<input
						type='checkbox'
						checked={formData.enableCursor ?? false}
						onChange={e => setFormData({ ...formData, enableCursor: e.target.checked })}
						className='accent-brand h-4 w-4 rounded'
					/>
					<span className='text-sm font-medium'>开启鼠标动画</span>
				</label>
			</div>
